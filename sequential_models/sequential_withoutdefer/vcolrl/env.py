...
class VCP(object):
    ...
    def __init__(self,max_epi_t=32,hamming_reward_coef=0.1,device='cpu',num_colors=15):
        ...
        print(f'VCP environment initialized with max_epi_t={self.max_epi_t}, device={self.device}, num_colors={self.num_colors}')
    ...
    def _take_action (self,action):
        ...
        self.graph.ndata['x_'][clashed&undecided]=self.num_colors+1 #remove undecided condition for hard rollback
