        ...
        for line in file:
            ...
            if line:
                ...
                for temp in current_list:
                    ...
                    current_edges_temp=[(int(node),int(neighbor)) for neighbor in neighbors]
                    current_edges.extend(current_edges_temp)
                    #g.add_edges_from((int(node),int(neighbor)) for neighbor in neighbors)
                g.add_nodes_from([i for i in range(len(current_nodes))])
